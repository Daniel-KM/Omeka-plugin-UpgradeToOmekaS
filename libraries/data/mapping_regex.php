...
return array(
    ...
    '~\b(queue_css_file)(\(.+?\))\;~'               => '$this->headLink()->appendStylesheet($this->assetUrl\2);',
    '~\b(queue_css_file)\(~'                        => '$this->upgrade()->\1(',
    '~\b(queue_css_url)\(~'                         => '$this->headLink()->appendStylesheet(',
    '~\b(queue_css_string)\(~'                      => '$this->headLink()->appendStyle(',
    '~\b(queue_js_file)(\(.+?\))\;~'                => '$this->headScript()->appendFile($this->assetUrl\2);',
    '~\b(queue_js_file)\(~'                         => '$this->upgrade()->\1(',
    '~\b(queue_js_url)\(~'                          => '$this->headScript()->appendFile(',
    '~\b(queue_js_string)\(~'                       => '$this->headScript()->appendScript(',
    ...
    '~WEB_RELATIVE_VIEW_SCRIPTS~'                   => '$this->assetUrl(\'\')',
